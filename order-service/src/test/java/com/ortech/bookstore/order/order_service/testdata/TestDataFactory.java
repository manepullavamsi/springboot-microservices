...
public class TestDataFactory {
    ...
    public static final Set<OrderItem> VALID_ORDER_ITEMS=Set.of(new OrderItem("P10","Product1",new BigDecimal(10),1));

    public static final Set<OrderItem> INVALID_ORDER_ITEMS=
            Set.of(new OrderItem("P1001","",new BigDecimal(1),0));
    public static CreateOrderRequest createValidOrderRequest()
    {
      return  Instancio.of(CreateOrderRequest.class)
              ...
              .set(field(Customer::phoneNumber),"98209029812")
                .generate(field(DeliveryDetails::addressCountry),gen-> gen.oneOf(VALID_COUNTRIES)).create();
    }
